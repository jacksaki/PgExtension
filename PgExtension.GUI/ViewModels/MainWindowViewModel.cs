...
using PgExtension.GUI.Extensions;
...
namespace PgExtension.GUI.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            var window = new InstallPythonWindow()
            {
        ...
        {
            yield return new NavigationMenuItem("SQL", typeof(SQLParentBox), PackIconKind.Transition);
            yield return new NavigationMenuItem("Objects", typeof(ObjectsBox), PackIconKind.Transition);
